...
import { 
  ...
  Star, Sparkles, CheckCircle, AlertCircle, User,
  Facebook, Twitter, Github, Globe,
  Shield, Zap, Crown, Heart, DollarSign, Coins,
  Target, Trophy, Rocket, Calendar, Phone
} from 'lucide-react';
      ...
      <div className="mb-8">
        ...
        <div className="relative">
          ...
          <input
            ...
            className={`w-full pl-12 pr-4 py-4 border rounded-2xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300 bg-gray-50/50 ${
              errors.dateOfBirth ? 'border-red-300 bg-red-50/50' : 'border-gray-200 hover:border-gray-300'
            }`}
          />
        </div>
        {errors.dateOfBirth && (
      ...
      <div className="space-y-4 mb-8">
        <label className="flex items-start cursor-pointer">
          ...
          <div className={`w-5 h-5 rounded border-2 flex items-center justify-center mt-1 transition-all duration-300 ${
            ...
            {agreeToTerms && <CheckCircle className="w-3 h-3 text-white" />}
          </div>
        ...
        <label className="flex items-start cursor-pointer">
          ...
          <div className={`w-5 h-5 rounded border-2 flex items-center justify-center mt-1 transition-all duration-300 ${
            ...
            {agreeToMarketing && <CheckCircle className="w-3 h-3 text-white" />}
          </div>
          <div className="ml-3 text-sm text-gray-600 leading-relaxed">
            I'd like to receive promotional emails about new offers and bonuses{' '}
            <span className="text-gray-400">(Recommended for max earnings)</span>
          </div>
        </label>
      </div>
    </>
        ...
        <div className="flex items-center justify-center mb-8">
          <div className="flex items-center space-x-4">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-300 ${
              currentStep >= 1 ? 'bg-indigo-500 text-white' : 'bg-gray-200 text-gray-400'
            }`}>
              1
            </div>
            ...
            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-300 ${
              currentStep >= 2 ? 'bg-indigo-500 text-white' : 'bg-gray-200 text-gray-400'
            }`}>
              2
            </div>
          </div>
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-100 p-8">
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-2xl p-4 mb-8 text-center">
            <div className="flex items-center justify-center space-x-2 mb-2">
              ...
              <span className="text-green-700 font-bold">$10 Welcome Bonus</span>
            </div>
            <p className="text-green-600 text-sm">Sign up today and get $10 credited to your account!</p>
          </div>
            ...
            <div className="flex space-x-4">
              {currentStep > 1 && (
                <button
                  ...
                  className="flex-1 border border-gray-200 text-gray-600 py-4 rounded-2xl font-semibold hover:bg-gray-50 transition-all duration-300"
                >
                  Back
                </button>
              )}
              ...
              <button
                ...
                disabled={isLoading}
                className="flex-1 relative overflow-hidden bg-gradient-to-r from-indigo-500 to-purple-600 text-white py-4 rounded-2xl font-semibold transition-all duration-300 hover:scale-105 hover:shadow-xl disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none group"
              >
                <div className="flex items-center justify-center space-x-3">
                  {isLoading ? (
                    ...
                    <>
                      {currentStep === 1 ? <Target className="w-5 h-5" /> : <Rocket className="w-5 h-5" />}
                      <span>{currentStep === 1 ? 'Continue' : 'Create Account & Claim $10'}</span>

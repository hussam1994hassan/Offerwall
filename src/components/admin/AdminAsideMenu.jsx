    ...
    return [
        {
            ...
            links: [
                {
                    label: PagesURL.ADMIN.TITLE,
                    icon: PagesURL.ADMIN.ICON,
                    href: PagesURL.ADMIN.URL,
                },
                {
                    label: PagesURL.ADMIN_USERS.TITLE,
                    icon: PagesURL.ADMIN_USERS.ICON,
                    href: PagesURL.ADMIN_USERS.URL,
                },
                {
...
const AdminAsideMenu = ({ getLinks = getSidebarLinks }) => {
